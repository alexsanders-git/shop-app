...
class FilterGroupsEditComponent extends Component
{
    public FilterGroup $filter_group;
    public string $title;

    public function mount(FilterGroup $filter_group): void
    {
    ...
    {
        return view('livewire.admin.filter.filter-groups-edit-component');
    }
}
